          ...
          <div class="modal-dialog modal-md my-0">
            <div class="modal-content">
              ...
              <div class="modal-footer">
                <button @click="showForm()" class="btn btn-secondary" data-dismiss="modal">
                  Close
                </button>
                <span @click="removeSource()" class="btn btn-danger" data-dismiss="modal"
                  >Delete</span
                >
...
export default {
  ...
  methods: {
    ...mapActions({
      actionUpdateSource: "calendar/updateSource",
      actionDeleteSource: "calendar/deleteSource",
    }),
    initForm() {
      this.source.name = "";
    },
