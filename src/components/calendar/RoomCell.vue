<template>
    ...
    >
      <div class="btn-grou">
        ...
        <ul class="dropdown-menu p-0 caldrpmen">
          <li
          ...
          >
            ...
            <div :class="['btn-' + color.color, 'text-' + color.color, 'index-' + index]" class="p-1">
              Color
            </div>
          </li>
  ...
  export default {
    ...
    computed: {
      ...mapGetters({
        getColors: "calendar/getColors",
        getSourceById: "calendar/getSourceById",
      }),
      isVisible() {
        if (this.event != null) {
    ...
    methods: {
      ...mapMutations({
        CREATE_ROOM_DAY: "calendar/CREATE_ROOM_DAY",
        CREATE_SOURCE_DAY: "calendar/CREATE_SOURCE_DAY",
        UPDATE_SOURCE_DAY: "calendar/UPDATE_SOURCE_DAY",
        REMOVE_SOURCE_DAY: "calendar/REMOVE_SOURCE_DAY",
        SET_IS_SAVE: "calendar/SET_IS_SAVE",
      }),
      ...mapActions({
        loadSourceForMonth: "calendar/loadSourceForMonth",
      }),
      showMenu() {
