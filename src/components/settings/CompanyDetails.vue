        ...
        <form @submit.prevent="save()" class="form-horizontal">
          <fieldset>
            ...
            <div id="logo" class="form-group row">
              <label class="control-label col-sm-2">Current Logo</label>
              <div v-if="company.logo" class="controls col-sm-4">
                <img :src="company.logo" alt="company-logo" style="max-height: 60px" />
              </div>
              <div v-else class="controls col-sm-4">
            ...
            <div class="form-group row">
              ...
              <div class="col-sm-5">
                <b-form-textarea
                  ...
                  rows="5"
                  placeholder="About the company, information, history, details.... etc."
                  cols="25"
                >
                </b-form-textarea>
              </div>
            ...
            <div class="form-group row">
              ...
              >
                <path
                  ...
                  fill="#0072b1"
                ></path>
                <path d="M7.11912 8.99744H3.55859V20.4506H7.11912V8.99744Z" fill="white"></path>
                <path
              ...
              <div class="col-sm-4">
                ...
                >
                  <b-form-input v-model="company.linkedIn"></b-form-input>
                </b-input-group>
              </div>
            </div>
            <div class="form-group row">
              ...
              <div class="col-sm-4">
                <b-input-group
                  size="sm"
                  style="width: 400px"
                  prepend="https://trustpilot.com/review/"
                >
                  <b-form-input v-model="company.trustpilot"></b-form-input>
                </b-input-group>
              </div>
            </div>
            <div class="form-group row">
          ...
          <fieldset>
            <input type="hidden" name="id" value="30658" />

            <input type="hidden" id="parentVendor_id" name="parentVendor.id" value="" />
  ...
  methods: {
    ...
    async save() {
      ...
      if (
        ...
        !this.company.website.includes("https://") &&
        !this.company.website.includes("http://")
      ) {
      ...
      const actionTodispatch = this.company.user > 0 ? "put" : "post";
      await this.$store
        .dispatch(`settings/${actionTodispatch}Company`, formData)
        // eslint-disable-next-line no-unused-vars
        .then(() => {
          this.$toast.success("The data is set successfully.");
