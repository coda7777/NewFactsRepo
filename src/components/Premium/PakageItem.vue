      ...
      <form @submit.prevent="startPay()">
        <div class="card-body">
            ...
            <div class="text-start">
              <div class="custom-control custom-radio">
                <input
                  ...
                  :value="'1'"
                />
                <label class="custom-control-label" :for="'customRadio0' + pakage.id"
                  >{{ pakage.six_months_price }} {{ pakage.currency
              ...
              <div class="custom-control custom-radio">
                <input
                  ...
                  :value="2"
                />
                <label class="custom-control-label" :for="'customRadio1' + pakage.id"
                  >{{ pakage.one_year_price }} {{ pakage.currency
                  }}<small class="h6">/ One year</small>
                </label>
              </div>
              <div class="custom-control custom-radio">
                <input
                  ...
                  :value="3"
                />
                <label class="custom-control-label" :for="'customRadio2' + pakage.id">
                  {{ pakage.two_years_price }} {{ pakage.currency }}
                  <small class="h6">/ Two years</small>
                </label>
              </div>
            </div>
            <button class="btn btn-success d-block w-100 mt-3 rounded-0 fw-bold py-1">
              <span
                v-show="isLoading"
          ...
          <div class="text-start mt-3">
            <span v-for="f in pakage.features" :key="f.id" class="d-block my-1 border text-start">
