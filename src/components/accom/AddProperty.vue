<template>
  <div class="container">
    <b-row>
      <b-col cols="10">
        <h4>List of your registered properties</h4>
        <span
          >Create and manage your Hotel-Resort-property in Ananas Global Facts.
          <b-icon
  ...
  methods: {
    ...
    async updateProperty() {
      ...
      await this.$store
        ...
        .then(() => {
          this.$toast.success("The property is updated successfully.");
        })
        .catch(() => {
    ...
    async AddProperty() {
      ...
      await this.$store
        ...
        .then(() => {
          this.$toast.success("The property is created successfully.");
        })
        .catch(() => {
          this.$toast.error("Something went wrong. Please try again later.");
        });
    ...
    async removeProperty() {
      await this.$store
        ...
        .then(() => {
          this.hideRemove();
          this.$toast.success("The property is deleted successfully.");
        })
        .catch(() => {
          this.$toast.error("Something went wrong. Please try again later.");
        });
